 ...
 * @package Sunlight\Congress
 */
class Votes extends ApiWrapper
{
    /**
     * @var string
     */
    protected $url = "https://congress.api.sunlightfoundation.com/votes";
}
